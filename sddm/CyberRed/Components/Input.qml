...
Column {
    ...
    Item {
            ...
            delegate: ItemDelegate {
                ...
                contentItem: Text {
                    ...
                    color: selectUser.highlightedIndex === index
                         ? config.DropdownSelectedTextColor
        ...
        TextField {
            ...
            background: Rectangle {
                ...
                border.width: username.activeFocus
                              ? config.InputFieldFocusBorderWidth
                              : config.InputFieldBorderWidth
                border.color: username.activeFocus
                              ? config.HighlightBorderColor
                              : config.LoginFieldBorderColor
    ...
    Item {
        ...
        TextField {
            ...
            placeholderTextColor: config.PasswordFieldTextColor
            passwordCharacter: "•"
            ...
            background: Rectangle {
                ...
                border.width: password.activeFocus
                              ? config.InputFieldFocusBorderWidth
                              : config.InputFieldBorderWidth
                border.color: password.activeFocus
                              ? config.HighlightBorderColor
                              : config.PasswordFieldBorderColor
        ...
        Button {
            ...
            contentItem: Text {
                ...
                color: loginButton.hovered
                     ? config.LoginButtonHoverTextColor
